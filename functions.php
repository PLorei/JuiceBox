...
function renard_scripts() {
	...
	wp_enqueue_script( 'scrollFix', $base . '/js/scrollFix.js', array( 'jquery' ), '1.2.4', true );
	wp_enqueue_script( 'toggleSearch', $base . '/js/toggleSearch.js', array( 'jquery' ), '1.2.4', true );
